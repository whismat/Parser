...
public class Pre_simulacro extends AppCompatActivity {
    ...
    String intent_asignatura;
    int intent_id;
    XmlPullParserFactory xmlFactoryObject;
    static boolean parsingComplete = true;
    static ArrayList<String[][]> simulacro = new ArrayList<String[][]>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent_id = myIntent.getIntExtra("id", 0);
        intent_asignatura= myIntent.getStringExtra("asignatura"); // will return "SecondKeyValue"

        setToolbar();  // Crear Toolbarç
        setSlider();
        setFloatingActionButton(); //Crear el FAB
        colorearPre_simulacro();  //Cambiar el color a la ActionBar, al Toolbar, al Slider, seleccionar la imagen
        parsear();
    ...
    private void setFloatingActionButton() {
        ...
        actionButton = (ActionButton) findViewById(R.id.pre_simulacro_action_button);
    ...
    private void colorearPre_simulacro() {
        if(intent_id==1)
        {
